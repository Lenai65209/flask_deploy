...
def articles_list():
    ...
    count_articles = requests.get('https://flask-deploy-vtwe.onrender.com/api/swagger/#/Article/get_api_articles_event_get_count_')
    # count_articles: Dict = requests.get('http://127.0.0.1:5000/api/articles/event_get_count/')
